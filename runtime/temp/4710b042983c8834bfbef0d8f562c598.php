...
<div class="container" style="padding-top:10px">
    <div style="width:100%;margin:0 auto;text-align:center;height:400px;font-weight:bold;font-size:20px;color:green">
		<p style="color:green"><i class="fa fa-check-square"></i> 亲，请扫码支付</p>
		<img src="<?php echo url('Pay/getQrcode'); ?>?data=<?php echo urlencode($url);?>" style="width: 300px" height="300px">
    </div>
</div>
	...
	<script>
		...
		function success() {
		    $.ajax({
				...
				url:"<?php echo url('Pay/getPayResult'); ?>",
				dataType:'json',
				success:function (res) {
				    console.log(res.status);
                    if(res.status == '已支付'){
                        window.location.href = "<?php echo url('Pay/pay_success'); ?>";
                    }
                }
			});
        }
